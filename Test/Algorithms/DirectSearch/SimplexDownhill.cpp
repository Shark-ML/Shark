...
BOOST_AUTO_TEST_CASE(SimplexDownhill_Reflection) {
	...
	RealVector p2(2);
	init(p2) << -0.5, -0.5;
	function.m_point.push_back(p0);
	function.m_value.push_back(0.0);
	function.m_point.push_back(p1);
	function.m_value.push_back(1.0);
	function.m_point.push_back(p2);
	function.m_value.push_back(2.0);
	RealVector x0 = 0.5 * (p0 + p1);
	RealVector xr = 2.0 * x0 - p2;
	function.m_point.push_back(xr);
	function.m_value.push_back(0.5);
...
BOOST_AUTO_TEST_CASE(SimplexDownhill_Contraction) {
	...
	function.m_point.push_back(xr);
	function.m_value.push_back(1.5);
	function.m_point.push_back(xc);
	function.m_value.push_back(1.8);
...
BOOST_AUTO_TEST_CASE(SimplexDownhill_Reduction) {
	...
	function.m_value.push_back(1.5);
	function.m_point.push_back(xc);
	function.m_value.push_back(3.0);
