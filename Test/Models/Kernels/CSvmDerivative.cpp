...
BOOST_AUTO_TEST_CASE(KERNEL_EXPANSION_CSVM_DERIVATIVE_TRIVIAL_DATASET_UNCONSTRAINED) {
	...
	Cs.push_back(0.2);
	Cs.push_back(0.1);
	Cs.push_back(0.01); //Cs.push_back(0.001); Cs.push_back(0.0001);
	double C_eps;
...
BOOST_AUTO_TEST_CASE(KERNEL_EXPANSION_CSVM_DERIVATIVE_TRIVIAL_DATASET_RBF) {
	...
	RbfParams.push_back(10);
	RbfParams.push_back(2);
	RbfParams.push_back(1);
	RbfParams.push_back(0.5);
	RbfParams.push_back(0.2);
	RbfParams.push_back(0.1);
	RbfParams.push_back(0.05);
	RbfParams.push_back(0.01);
	RbfParams.push_back(0.001);
...
//	Cs.push_back(100); Cs.push_back(10); //responsible for the highest of the in-accuracies encountered
	...
	ArdParams.push_back(10);
	ArdParams.push_back(2);
	ArdParams.push_back(1);
	ArdParams.push_back(0.5);
	ArdParams.push_back(0.2);
	ArdParams.push_back(0.1);
	ArdParams.push_back(0.05);
	ArdParams.push_back(0.01);
	ArdParams.push_back(0.001);
	ArdParams.push_back(0.0001);
