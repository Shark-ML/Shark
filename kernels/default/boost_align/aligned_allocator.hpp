...
#include "detail/is_alignment_constant.hpp"
#include "detail/max_objects.hpp"
#include "detail/max_size.hpp"
...
private:
    enum {
        min_align = detail::max_size<Alignment,std::alignment_of<value_type>::value>::value
    };
