...
trsv_kernel createTRSVDiagBlockKernel(
	...
	vector_expression<VecB, opencl_tag> &b_unreg,
	char const* options
){
	...
	opencl::detail::meta_kernel k("blas_trsv");
...
void trsv_recursive(
	matrix_expression<MatA, opencl_tag> const& Afull, 
	vector_expression<VecB, opencl_tag> & bfull,
	trsv_kernel& kernel,
	std::size_t start,
	std::size_t end,
	std::size_t tileSize,
