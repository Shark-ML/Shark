 ...
 */
//===========================================================================
#ifndef REMORA_KERNELS_OPENCL_GEMV_HPP
#define REMORA_KERNELS_OPENCL_GEMV_HPP
...
void gemv(
	...
	vector_expression<VecX, opencl_tag> const& x_unreg,
	vector_expression<VecV, opencl_tag>& v_unreg, 
	...
	opencl::detail::meta_kernel k("blas_gemv");
