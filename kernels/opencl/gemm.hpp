 ...
 */
//===========================================================================
#ifndef REMORA_KERNELS_OPENCL_GEMM_HPP
#define REMORA_KERNELS_OPENCL_GEMM_HPP
...
void gemm(
	matrix_expression<MatA, opencl_tag> const& A_unreg,
	matrix_expression<MatB, opencl_tag> const& B_unreg,
	matrix_expression<MatC, opencl_tag>& C_unreg, 
	...
	// TILE_SIZE_K: length of Tile loaded from A and C, i.e A and C are loaded as (TILE_SIZE, TILE_SIZE_K) matrices
	...
	k << "const ulong maxCi = min(TILE_SIZE, M -  get_group_id(0) * TILE_SIZE);\n";
