...
namespace shark{ namespace blas{
     ...
     * Directly iboost::mplement nonassignable - siboost::mplifes debugging call trace!
     * 
    ...
    public:
        ...
        /* E can be an incoboost::mplete type - to define the following we would need more template arguments
