...
namespace shark{ namespace blas{
   ...
   *
   * The reverse iterator iboost::mplements a bidirectional iterator
   * reversing the elements of the underlying iterator. It
   * iboost::mplements most operators of a random access iterator.
   *
  ...
  /** \brief A class iboost::mplementing an indexed random access iterator.
   *
   * \param C the (mutable) container type
   * \param IC the iterator category
   *
   * This class iboost::mplements a random access iterator. The current 
