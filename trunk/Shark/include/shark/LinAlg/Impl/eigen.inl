 ...
 */
//===========================================================================
#ifndef SHARK_LINALG_EIGEN_INL
#define SHARK_LINALG_EIGEN_INL
#include <cmath>
...
void Exc(MatrixT &A, VectorT &D, std::size_t j, std::size_t k, std::size_t l, std::size_t m)
{  // used by Balanc
	...
	if (j != m)
	{
		...
		//for (ii = l; ii < n + 1; ii++)
		for (size_t ii = 1; ii < n; ii++) // b.roeschies 12/13/2007: changed because ii goes beyond array bounds (ii == A.dim(0) + 1 in the last step).
		{
			double f = A(j, ii);
			A(j, ii) = A(m, ii);
			A(m, ii) = f;
 ...
 */
template<class MatrixT,class VectorT>
void Balanc(MatrixT &A, VectorT &D, int &low, int &hi)
{
...
(int     low,         /* first nonzero row ...........*/
 ...
 MatrixT &h,   /* Hessenberg matrix ...........*/
 VectorT &wr,  /* Real parts of eigenvalues....*/
 VectorT &wi,  /* Imaginary parts of evalues ..*/
 VectorT &cnt  /* Iteration counter ...........*/
)
/*====================================================================*
 *                                                                    *
 ...
 */
template<class MatrixT,class VectorT>
void shark::eigen(const MatrixT& amatA, VectorT& vr, VectorT& vi)
{
