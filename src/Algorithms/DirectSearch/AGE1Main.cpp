...
int main( int argc, char ** argv ) {
	...
	if( vm.count( "algorithmUsage" ) > 0 ) {
		shark::OptimizerTraits< shark::detail::AGE >::usage( std::cout );
		return( EXIT_SUCCESS );
	}
	...
	if( objectiveFunction == "DTLZ1" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ1 > runner;
		runner.run( 
	...
	if( objectiveFunction == "DTLZ2" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ2 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
	...
	if( objectiveFunction == "DTLZ3" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ3 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
	...
	if( objectiveFunction == "DTLZ4" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ4 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
	...
	if( objectiveFunction == "DTLZ5" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ5 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
	...
	if( objectiveFunction == "DTLZ6" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ6 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
	...
	if( objectiveFunction == "DTLZ7" ) {
		shark::moo::InterruptibleAlgorithmRunner< shark::detail::AGE, shark::DTLZ7 > runner;
		runner.run( 
			vm[ "seed" ].as< unsigned int >(),
			vm[ "storageInterval" ].as< unsigned int >(),
			vm[ "searchSpaceDimension" ].as< unsigned int >(),
