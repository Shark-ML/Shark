...
namespace detail{
	...
	public:
		...
		blas::vector_unary<E, Function<typename E::value_type> > operator()(blas::vector_expression<E, Device> const& x)const{
		...
		template<class E, class Device>
		blas::matrix_unary<E, Function<typename E::value_type> > operator()(blas::matrix_expression<E, Device> const& x)const{
			typedef Function<typename E::value_type> functor_type;
		...
		template<class E, class Device>
		blas::vector_unary<E, FunctionDerivative<typename E::value_type> > derivative(blas::vector_expression<E, Device> const& x)const{
		...
		///It's input is a matrix or vector of previously calculated neuron responses generated by operator()
		template<class E, class Device>
		blas::matrix_unary<E, FunctionDerivative<typename E::value_type> > derivative(blas::matrix_expression<E, Device> const& x)const{
			typedef FunctionDerivative<typename E::value_type> functor_type;
			return blas::matrix_unary<E, functor_type >(x(),functor_type(this));
		}
	};
