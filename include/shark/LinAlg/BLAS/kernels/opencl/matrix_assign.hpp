/*!
 * \brief       Kernels for matrix-expression assignments on the opencl
 * 
 * \author      O. Krause
 * \date        2016
 *
...
void matrix_apply(
	matrix_expression<M, opencl_tag>& m_unreg, 
	F const& f_unreg,
	Orientation
){
...
template<class F, class M, class Orientation>
void matrix_assign(
	matrix_expression<M, opencl_tag>& m, 
...
void matrix_assign_functor(
	matrix_expression<M, opencl_tag>& m_unreg, 
	matrix_expression<E, opencl_tag> const& e_unreg,
	F f_unreg,
...
void matrix_assign(
	...
	matrix_assign_functor(m, e, device_traits<opencl_tag>::right_arg<typename E::value_type>(), o, o, t, t);
}
...
void matrix_assign(
	...
	matrix_assign_functor(m, e, device_traits<opencl_tag>::right_arg<typename E::value_type>(), o1, o2, t, t);
}
