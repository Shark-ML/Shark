...
struct ELLI2 : public MultiObjectiveFunction{
	...
	void init() {
		m_rotationMatrix1 = blas::randomRotationMatrix(random::globalRng(), numberOfVariables() );
		m_rotationMatrix2 = blas::randomRotationMatrix(random::globalRng(), numberOfVariables() );
	}
